...
TYPE_GUIDE = {
    ...
    "true_false": (
        ...
        'answered with "answer_is_true". Make about half the statements false, and make '
        "each false one a plausible distortion of something the video actually says, "
        "never an absurd claim."
    ),
}
...
GENERATION_SYSTEM_PROMPT = (
    ...
    "correct one is not obvious from its shape.\n\n"
...
VALIDATION_SYSTEM_PROMPT = (
    ...
    "(1) its cited topic's content supports every option marked correct; "
    ...
    "(3) the question is unambiguous and answerable from the video alone. Respond with "
