...
- **Slip detection is unreliable here.** The judge flagged the same repeated slip in one run and missed it in the other. Treat `speaker_slips` as a floor, not a count.
